...
{
    public partial class Request_6 : Form
    {
        public Request_6()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "SELECT e.full_name FROM program_ether pe JOIN employees e ON pe.id_employee = e.id_employees WHERE pe.date_holding BETWEEN '2022-05-01' AND '2022-05-02'";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Cписок робітників, які були в ефірі с 2022-05-01 до 2022-05-02";
