...
{
    public partial class Request_11 : Form
    {
        public Request_11()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "SELECT e.full_name FROM employees e WHERE e.id_employees = ALL( SELECT p.id_employee FROM program_ether p GROUP BY p.id_employee HAVING COUNT(p.id_program_ether) >= ALL( SELECT COUNT(pe.id_program_ether) FROM program_ether pe GROUP BY pe.id_employee ))";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Хто з співробітників провів більш за всіх ефірів?";
