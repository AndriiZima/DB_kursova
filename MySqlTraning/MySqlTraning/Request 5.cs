...
namespace MySqlTraning
{
    public partial class Request_5 : Form
    {
        ...
        {
            DB db = new DB();
            string showDate = "SELECT pa.name_program FROM program_accounting pa JOIN program_ether pe ON pa.id_program_accounting = pe.id_program_accounting WHERE pe.date_holding BETWEEN '2022-05-01' AND '2022-05-02'";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Cписок програм, які були проведені с 2022-05-01 до 2022-05-02";
