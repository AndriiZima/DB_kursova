...
namespace MySqlTraning
{
    public partial class Request_3 : Form
    {
        ...
        {
            DB db = new DB();
            string showDate = "SELECT full_name FROM employees WHERE full_name LIKE 'А%'";
        ...
        {
            System.Drawing.Printing.PrintPageEventArgs ep = e;
            string queryName = "Знайти ведучого, прізвище якого починається на літеру А";
            PrintClass printClass = new PrintClass();
            printClass.Print(queryName, ep, dataGridView1);
            /*
