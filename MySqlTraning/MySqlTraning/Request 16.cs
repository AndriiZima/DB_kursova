...
{
    public partial class Request_16 : Form
    {
        public Request_16()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "SELECT e.full_name FROM employees e WHERE e.id_work_position = 1 AND e.id_employees NOT IN( SELECT p.id_emloyees FROM plot p)";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "У кого з співробітників немає сюжету?";
