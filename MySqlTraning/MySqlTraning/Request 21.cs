...
{
    public partial class Request_21 : Form
    {
        public Request_21()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "UPDATE program_accounting pa SET pa.more_information = 'Ця програма найчастіше виходить в ефір' WHERE pa.id_program_accounting = ( SELECT id_program_accounting FROM program_ether GROUP BY id_program_accounting ORDER BY COUNT(*) DESC LIMIT 1)";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Запис \"Ця програма найчастіше вихдить в ефір\"";
