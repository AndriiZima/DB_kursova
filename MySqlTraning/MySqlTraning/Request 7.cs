...
{
    public partial class Request_7 : Form
    {
        public Request_7()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "SELECT COUNT(*) AS total_ethers FROM program_ether WHERE date_holding >= CURDATE() - INTERVAL 7 DAY";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Скільки ефіров вийшло за останній тиждень?";
