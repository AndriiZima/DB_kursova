...
{
    public partial class Request_12 : Form
    {
        public Request_12()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "SELECT e.full_name FROM employees e WHERE e.id_employees = ANY( SELECT pe.id_employee FROM program_ether pe GROUP BY pe.id_employee HAVING COUNT(pe.id_program_ether) <= ALL( SELECT COUNT(pe2.id_program_ether) FROM program_ether pe2 GROUP BY pe2.id_employee ))";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Хто з співробітників провів менш за всіх ефірів?";
