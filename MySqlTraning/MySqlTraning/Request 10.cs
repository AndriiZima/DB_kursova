...
{
    public partial class Request_10 : Form
    {
        public Request_10()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "SELECT e.full_name, COUNT(p.id_plot) AS total_plots FROM plot p JOIN employees e ON p.id_emloyees = e.id_employees GROUP BY e.full_name";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Скільки сюжетів зробив кожен робітник?";
