...
{
    public partial class Request_13 : Form
    {
        public Request_13()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "SELECT e.full_name, pa.name_program FROM employees e JOIN program_accounting pa ON e.id_employees = pa.id_employees WHERE EXISTS( SELECT 1 FROM program_ether pe WHERE pe.id_employee = e.id_employees)";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Список співробітників та програм, співробітники яких вели програми в ефірі";
