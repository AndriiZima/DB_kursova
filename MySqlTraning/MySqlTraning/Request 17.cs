...
{
    public partial class Request_17 : Form
    {
        public Request_17()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "SELECT g.full_name FROM guests_program g WHERE NOT EXISTS( SELECT 1 FROM directory_participants p WHERE g.id_participants = p.id_participants)";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Кого з гостей немає в списку учасників?";
