...
{
    public partial class Request_9 : Form
    {
        public Request_9()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "SELECT e.full_name, COUNT(pe.id_program_ether) AS total_ethers FROM program_ether pe JOIN employees e ON pe.id_employee = e.id_employees GROUP BY e.full_name";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Скільки ефірів провів кожен робітник?";
