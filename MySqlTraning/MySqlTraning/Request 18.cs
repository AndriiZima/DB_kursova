...
{
    public partial class Request_18 : Form
    {
        public Request_18()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "SELECT e.full_name, 'Має найбільше проведених ефірів' AS comment FROM employees e WHERE e.id_employees = ( SELECT id_employee FROM program_ether GROUP BY id_employee ORDER BY COUNT(*) DESC LIMIT 1 ) UNION SELECT e.full_name, '' AS comment FROM employees e WHERE e.id_employees<>( SELECT id_employee FROM program_ether GROUP BY id_employee ORDER BY COUNT(*) DESC LIMIT 1)";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Cписок співробітників з коментарем: \"Має найбільше проведених ефірів\"";
