...
namespace MySqlTraning
{
    public partial class Request_2 : Form
    {
        ...
        {
            DB db = new DB();
            string showDate = "SELECT pa.name_program FROM program_accounting pa JOIN employees e ON pa.id_employees = e.id_employees WHERE e.full_name = 'Антоненко Олег Васильович' AND e.id_work_position = 1";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Вивести список програм, який веде заданий робітник";
