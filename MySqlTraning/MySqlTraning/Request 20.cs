...
{
    public partial class Request_20 : Form
    {
        public Request_20()
        {
            InitializeComponent();
        ...
        {
            DB db = new DB();
            string showDate = "UPDATE employees e SET more_information = 'Провів найбільшу кількість ефірів' WHERE e.id_employees = ( SELECT id_employee FROM program_ether GROUP BY id_employee ORDER BY COUNT(*) DESC LIMIT 1)";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int y1 = marginTop;
            // Друк назви запиту
            string queryName = "Запис \"Провів найбільшу кількість ефірів\" у таблицю співробітників";
